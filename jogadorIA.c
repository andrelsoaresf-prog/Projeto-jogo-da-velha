...
void regras(int **tabuleiro){
    ...
    else if (tabuleiro[0][0] + tabuleiro[0][2] == 8 && tabuleiro[0][1] == 0){
        tabuleiro[0][1] = 4;
    }
    ...
    else if (tabuleiro[1][0] + tabuleiro[1][2] == 8 && tabuleiro[1][1] == 0){
        tabuleiro[1][1] = 4;
    }
    ...
    else if (tabuleiro[2][0] + tabuleiro[2][2] == 8 && tabuleiro[2][1] == 0){
        tabuleiro[2][1] = 4;
    }
    ...
    else if (tabuleiro[0][0] + tabuleiro[2][0] == 8 && tabuleiro[1][0] == 0){
        tabuleiro[1][0] = 4;
    }
    ...
    else if (tabuleiro[0][1] + tabuleiro[2][1] == 8 && tabuleiro[1][1] == 0){
        tabuleiro[1][1] = 4;
    }
    ...
    else if (tabuleiro[0][2] + tabuleiro[2][2] == 8 && tabuleiro[1][2] == 0){
        tabuleiro[1][2] = 4;
    }
